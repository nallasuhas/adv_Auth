...
const PasswordCriteria = ({password}) => {
    ...
    <div className='mt-2 space-y-1'>
        {/* check if the criteria is matched and render accordingly */}
        {criteria.map((item) => (
...
export default function PasswordStrength({password}) {
    ...
    // get color accord to the strength of the password
  ...
  return (
    ...
    <div className='mt-2'>
        ...
        {/* div containing 4 strength bars */}
        <div className='flex space-x-1'>
            {/* generate an array of 4 elements and map throught it to get 4 strength bars */}
            {[...Array(4)].map((_, index) => (
                <div 
                key={index}
